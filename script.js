...
function render() {
  ...
  root.innerHTML = `
    ...
    <div class="section">
      <h2>🔍 Buscar Jogos</h2>
      <input type="text" id="searchInput" class="search-box" placeholder="Buscar por nome ou código Xbox..." 
             value="${state.busca}" onkeyup="updateBusca(this.value)" onclick="event.stopPropagation()">
    </div>
    ...
    <div class="section">
      ...
      <div class="games-grid">
        ${jogosFiltrados.length === 0 ? '<p style="text-align: center; grid-column: 1/-1;">Nenhum jogo encontrado com esses filtros.</p>' : ''}
