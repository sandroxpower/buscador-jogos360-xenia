...
function render() {
  ...
  root.innerHTML = `
    <h1><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">🎮</span> Buscador Xenia Canary</h1>
    <div class="header-info">
      <p>Total de Jogos: <strong>944</strong> | Gameplay: <strong>688</strong> | Comentários Reais: <strong>296+</strong></p>
    </div>

    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">⚙️</span> Configuração do Hardware</h2>
      ...
      ${scorePC === 4 ? `
        <div style="margin-top: 20px; padding: 20px; background: #fff3cd; border-radius: 8px; border-left: 4px solid #ffc107;">
          <h4 style="color: #856404; margin-bottom: 10px;">💡 Recomendação para Configuração Mínima (i3 2 cores, GTX 750 Ti, 8GB)</h4>
          <p style="color: #856404; margin-bottom: 15px;">Com esta configuração, você terá melhor desempenho com jogos 2D e títulos 3D otimizados em resolução nativa (720p).</p>
          
          <strong style="color: #856404;">🎮 Jogos com Bom Desempenho (Recomendados):</strong>
          <ul style="list-style: none; padding: 0; color: #856404;">
            <li>✓ Batman: Arkham Asylum GOTY Edition</li>
            <li>✓ Comic Jumper</li>
            <li>✓ Dante's Inferno (60fps possível)</li>
            <li>✓ Dishwasher: Dead Samurai</li>
            <li>✓ Dragon Ball Z Burst Limit</li>
            <li>✓ Geometry Wars: Retro Evolved 2</li>
            <li>✓ Guitar Hero World Tour</li>
            <li>✓ Metal Gear Rising: Revengeance</li>
            <li>✓ Mortal Kombat 9</li>
            <li>✓ Resident Evil 5</li>
            <li>✓ Sonic the Hedgehog (2006)</li>
          </ul>

          <strong style="color: #856404; margin-top: 15px; display: block;">📌 Dicas de Configuração:</strong>
          <ul style="list-style: none; padding: 0; color: #856404;">
            <li>✓ Use Xenia Canary (mais otimizado)</li>
            <li>✓ GPU: D3D12 ativado</li>
            <li>✓ Resolução: 720p (1x nativo)</li>
            <li>✓ Mantenha resolution_scale em 1</li>
          </ul>
        </div>
      ` : ''}
    </div>
    ...
    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">📋</span> Gerar Configuração</h2>
    ...
    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">🔍</span> Buscar Jogos</h2>
    ...
    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">🎮</span> Filtrar por Status</h2>
      <div class="filters">
    ...
    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">📂</span> Filtrar por Categoria</h2>
      <div class="filters">
        ${categorias.map(cat => {
    ...
    <div class="section">
      <h2><span style="background: none; -webkit-text-fill-color: unset; background-clip: unset; color: #000;">🕹️</span> Jogos Encontrados</h2>
