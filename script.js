...
function render() {
  ...
  root.innerHTML = `
    <h1><span class="emoji">🎮</span> Buscador Xenia Canary</h1>
    <div class="header-info">
      <p>Total de Jogos: <strong>944</strong> | Gameplay: <strong>688</strong> | Comentários Reais: <strong>296+</strong></p>
    </div>

    <div class="section">
      <h2><span class="emoji">⚙️</span> Configuração do Hardware</h2>
    ...
    <div class="section">
      <h2><span class="emoji">📋</span> Gerar Configuração</h2>
    ...
    <div class="section">
      <h2><span class="emoji">🔍</span> Buscar Jogos</h2>
    ...
    <div class="section">
      <h2><span class="emoji">🎮</span> Filtrar por Status</h2>
      <div class="filters">
    ...
    <div class="section">
      <h2><span class="emoji">📂</span> Filtrar por Categoria</h2>
      <div class="filters">
        ${categorias.map(cat => {
    ...
    <div class="section">
      <h2><span class="emoji">🕹️</span> Jogos Encontrados</h2>
